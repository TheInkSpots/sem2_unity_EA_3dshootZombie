...
public class HighScoreManager : MonoBehaviour
{
    ...
    public void EnterName()
    {
        ...
        if (enterName.text != string.Empty) //Makes sure that we have some text to enter
        {
            //int score = UnityEngine.Random.Range(1, 500); //Generates a random score
             ...
             //int score = EnemyManager.playerScore; // get other class' int
            playerName = enterName.text; // momo created for store the name 
    ...
    public void saveScore()
    {
        ...
        if (playerName != string.Empty) //Makes sure that we have some text to enter
        {
            //int score = UnityEngine.Random.Range(1, 500); //Generates a random score

            int score = EnemyManager.playerScore; // get other class' int
            // momo created for store the name 
            Debug.Log("name: " + playerName);
            Debug.Log("score: " + score);
            
            InsertScore(playerName, score); //Inserts the score in the database
